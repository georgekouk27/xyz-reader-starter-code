...
public class ArticleDetailFragment extends Fragment implements
    ...
    FloatingActionButton mShareFloatingActionButton;
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            Glide.with(mPhotoView.getContext()).load(mCursor.getString(ArticleLoader.Query.PHOTO_URL)).apply(options).into(mPhotoView);
